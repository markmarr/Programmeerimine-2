...
teachersController.getTeacher = (req, res) => {
  const serviceRes = teachersService.getTeacher(req);
  if(serviceRes === -1) {
    res.status(404).json({
      error: "Cannot find the specific week"
    });
...
teachersController.updateTeacher = (req, res) => {
  const serviceRes = teachersService.updateTeacher(req);
  if(serviceRes === -1) {
    res.status(404).json({
      error: "Cannot find the specific week"
    });
...
teachersController.deleteTeacher = (req, res) => {
  const serviceRes = teachersService.deleteTeacher(req);
  if(serviceRes === -1) {
    res.status(404).json({
      error: "Cannot find the specific week"
    });
...
teachersController.createTeacher = (req, res) => {
  const serviceRes = teachersService.createTeacher(req);
  if(serviceRes === -1) {
    res.status(404).json({
      error: "Cannot find the specific week"
    });
